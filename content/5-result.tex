...
\begin{figure}[!ht]
\centering
\includegraphics[scale=.5]{img/scatteriPhone}
...
The diversity of the devices brands in the measurement is have not changed significant compared to measurements.
...
That however did not result in the same stability in permanence as seen in table~\ref{tab:featureGyro}.
