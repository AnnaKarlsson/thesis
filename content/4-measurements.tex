...
To measure the camera two measurements where gathered in both cases where the device on a flat surface which makes the camera result black. Both of this measurements is analysed by the PRNU-method used in~\cite[]{sensor:camera:DCIdent} described in~\sectionref{sec:ResCam}.
\begin{enumerate}
