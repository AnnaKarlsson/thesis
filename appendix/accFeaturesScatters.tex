...
In the result of motion measurements II (~\sectionref{res:testII}, plots were scattered to analyze which features that are most suitable for device fingerprinting. This appendix includes these plots that are used in~\sectionref{res:testII} and discussed in~\sectionref{sec:concl:choose}.
